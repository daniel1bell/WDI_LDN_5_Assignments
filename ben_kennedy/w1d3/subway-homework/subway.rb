...
puts ("You'll travel #{distance} stops to get from #{start_station} on the #{start_line} to #{finish_station} on the #{finish_line}" + (' via a change at ' + intersection if intersection)).delete '[]:"'
end